...
def main():
    registry = Registry()
    spec = registry.presets["gemini-flash-native"] # "gemini-flash-native" | "deepseek-chat"
    adapter = LLMClientAdapter(spec)

    user_query = "Estimate the electricity demand and RRP in QLD1 on April 10th, 2025 at 7pm."
